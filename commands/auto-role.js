...
module.exports.config = {
	...
	aliases: ["auto-roles","autorole","autorl","atrl"],
	serverForced: true
}

module.exports.help = {
	description: "Permet de donner automatiquement un [role] en rajoutant une réaction d'un [émoji].",
	utilisations: `auto-role [salon] [ID message] [émoji] [ID/mention role]\nauto-role [salon] [ID message] [émoji] supprimer`,
	exemples: `auto-role #général 541358571988975616 :wave: @Hey`
}